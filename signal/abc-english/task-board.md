...
| --- | **Phase 10: 앱 지원 API (/api/v1/)** — abc-english-app 클라이언트용 백엔드 확장 | --- | --- | --- | --- | --- | --- |
| TASK-100 | web/api/v1/__init__.py + deps.py (Bearer 의존성, settings에 ABC_API_TOKEN 추가, app.py에 v1 router include) | coder | DONE | HIGH | TASK-032 | 2026-04-22 | 2026-04-22T10:50 |
| TASK-101 | /api/v1/episodes GET (page/size/since_modified 쿼리, 기존 episodes.py 로직 참조) | coder | DONE | HIGH | TASK-100 | 2026-04-22 | 2026-04-22T10:50 |
| TASK-102 | /api/v1/episodes/{id} GET (상세+문장 리스트+타임스탬프) | coder | DONE | HIGH | TASK-100 | 2026-04-22 | 2026-04-22T10:50 |
| TASK-103 | /api/v1/episodes/{id}/audio GET (기존 audio.py 재사용 — Range 지원) | coder | DONE | HIGH | TASK-100 | 2026-04-22 | 2026-04-22T10:50 |
| TASK-104 | /api/v1/episodes/{id}/manifest GET (파일 목록 + ETag/체크섬) | coder | DONE | MEDIUM | TASK-100 | 2026-04-22 | 2026-04-22T10:50 |
| TASK-105 | /api/v1/lookup GET (단어 조회, 기존 lookup.py 위임) | coder | DONE | MEDIUM | TASK-100 | 2026-04-22 | 2026-04-22T10:50 |
| TASK-106 | /api/v1/notebook CRUD (GET/POST/PATCH/DELETE + last_modified 필드) | coder | DONE | MEDIUM | TASK-100 | 2026-04-22 | 2026-04-22T10:50 |
| TASK-107 | /api/v1/notebook/sync POST (오프라인 변경 배치 업로드, LWW 처리) | coder | DONE | MEDIUM | TASK-106 | 2026-04-22 | 2026-04-22T10:50 |
| TASK-108 | /api/v1/ 통합 단위테스트 (Bearer 검증, 각 엔드포인트 계약) | tester | DONE | HIGH | TASK-101,TASK-102,TASK-103,TASK-104,TASK-105,TASK-106,TASK-107 | 2026-04-22 | 2026-04-22T11:10 |
| TASK-108-FIX | /api/v1/episodes — malformed since_modified 를 400 → 422 로 교정 + test_api_v1.py 대응 assertion 좁히기 + Pydantic `.dict()` → `.model_dump()` + FastAPI `@on_event` → lifespan 이관 | coder | agent | DONE | HIGH | TASK-108 | 2026-04-22 | 2026-04-22T11:25 |
